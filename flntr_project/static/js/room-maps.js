//get all the django variables from the HTML
//latitude and longitude of the flat
var lat = $("#flat_lat").val();
var lng = $("#flat_lng").val();
//paths for the pin locations
var title = $("#flat_title").val();
var shop_pin = $("#shop_pin").val();
var ent_pin = $("#ent_pin").val();
var sport_pin = $("#sport_pin").val();
var food_pin = $("#food_pin").val();
